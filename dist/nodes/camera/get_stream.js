...
var GetStream = exports.GetStream = function (_SimpleNode) {
  _inherits(GetStream, _SimpleNode);

  function GetStream(path, provider) {
    _classCallCheck(this, GetStream);

    var _this = _possibleConstructorReturn(this, (GetStream.__proto__ || Object.getPrototypeOf(GetStream)).call(this, path, provider));
